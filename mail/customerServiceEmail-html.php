                        ...
                        <div class="block-grid two-up no-stack" data-body-width-father="650px" rel="col-num-container-box-father" style="Margin: 0 auto; min-width: 320px; max-width: 650px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #FFFFFF;">
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                                ...
                                <div class="col num6" data-body-width-son="325" rel="col-num-container-box-son" style="min-width: 320px; max-width: 325px; display: table-cell; vertical-align: top;">
                                    <div style="width:100% !important;padding:20px 0">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:25px; padding-bottom:25px; padding-right: 0px; padding-left: 25px;">
                                            ...
                                            <div align="left" class="img-container left fixedwidth" style="padding-right: 0px;padding-left: 0px;">
                                                ...
                                                <img alt="Image" border="0" class="left fixedwidth" src="<?= $logoimg; ?>" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; border: 0; height: auto; float: none; width: 100%; max-width: 195px; display: block;" title="Image" width="195" />
                                ...
                                <div class="col num12" data-body-width-son="650" rel="col-num-container-box-son" style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top;">
                                    <div style="width:100% !important;">
                                        ...
                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:60px; padding-right: 25px; padding-left: 25px;">
                                            ...
                                            <div style="color:#052d3d;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:150%;padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:15px;">
                                                <div style="font-size: 12px; line-height: 18px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #052d3d;">
                                                    <p style="font-size: 14px; line-height: 75px;  margin: 0;">
                                                    <span style="font-size: 40px;"><strong><span style="line-height: 75px; font-size: 40px;">
                                                    <span style="font-size: 38px; line-height: 57px;">Request Recieved</span></span></strong></span></p>
                                                    <p style="font-size: 14px; line-height: 51px;  margin: 0;"><span style="font-size: 24px;"><strong>
                                                        <span style="line-height: 51px; font-size: 34px;"><span style="color: #2190e3; line-height: 51px; font-size: 24px;">Hi <?= Html::encode($user->first_name)." ".Html::encode($user->last_name) ?>, </span></span></strong></span></p>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->
                                                <div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:0px;">
                                                    <div style="font-size: 12px; line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #555555;">
                                                        <p style="font-size: 14px; line-height: 21px;  margin: 0;"><span style="font-size: 16px; color: #000000; line-height:1.5em">Thank you for reaching out to NoCopyCopy support desk. <br><br>
                                                        We have received your email, and our support team will be in touch with you soon. </span></p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                                <!--[if (!mso)&(!IE)]><!-->
                                                    ...
                                                    <div style="font-size: 12px; line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #4F4F4F;">
                                                        <p style="font-size: 12px; line-height: 16px; text-align: center; margin: 0;">
                                                            <span style="font-size: 14px;">
                                                                <span style="background-color: transparent; line-height: 16px; font-size: 14px;">+2348095293779</span>
                                                            </span>
                                                        </p>
                                                    </div>
                                                </div>
