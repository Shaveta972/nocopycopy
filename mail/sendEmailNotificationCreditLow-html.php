...
<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;">
 <span style="font-size: 16px; color: #000000; line-height:1.5em">
    <p>Hello <?= Html::encode($user->first_name) ?>,</p>
    <p>We hope you enjoy NoCopyCopy and find it helpful.</p>
    <p>We would like to inform you that your credits are running low. Please contact to your Education admin to allocate more credits.</p>
</span>
</p>
</div>
</div>
