...
$this->title = \Yii::t('app','Terms & Conditions');
?>
<div class="terms_conditions">
	<div class="container py-5">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="theme-heading text-left mb-5">
				...
				<div class="content">
					...
					<div class="box">
						...
						<blockquote>PLEASE NOTE: We reserve the right, at our sole discretion, to change, modify or otherwise alter these Terms and Conditions at any time. Unless otherwise indicated, amendments will become effective immediately. Please review these Terms and Conditions periodically. Your continued use of the Site following the posting of changes and/or modifications will constitute your acceptance of the revised Terms and Conditions and the reasonableness of these standards for notice of changes.<a href="#">link</a> For your information, this page was last updated as of the date at the top of these terms and conditions.</blockquote>
					</div>
					...
					<div class="box">
						<h3>6. Exclusions & Limitations</h3>
					...
					<div class="box">
						<h3>9.Copyright & Trademark Notice</h3>
					...
					<div class="box">
						...
						<ul>
							<li class="pb-2">generator.lorem-ipsum.info</li>
							<li class="pb-2">126 Electricov St.</li>
							<li class="pb-2">Kiev, Kiev 04176</li>
							<li class="pb-2">Ukraine</li>
							<li class="pb-2">contact@lorem-ipsum.info</li>
						</ul>
					</div>
