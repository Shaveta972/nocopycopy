    ...
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5"> 
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h2 class="pb-2 fw-bold panel-header-heading">Staff Members</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <?php Pjax::begin(['id' => 'staff-grid']) ?>
                                <div class="table-responsive">
                                    ...
                                    echo GridView::widget([
                                        'dataProvider' => $referralStaffdataProvider,
                                        'pjax' => true,
                                        'pjaxSettings' => [
                                            'options' => [
                                                'id' => 'data-grid',
                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'label' => 'Email Confirm',
                                                'value' => function ($data) {
                                                    return ($data->is_confirmed == 1) ? '<span class="label label-md label-primary">Confirmed</span>'
                                                        : '<span class=label label-md label-warning">Unconfirmed</span>';
                                                }
                                            ],
