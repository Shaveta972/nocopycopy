				...
				<?php	//if (Yii::$app->user->isGuest) { ?>
					...
					<?php //}	?>
						...
						<li class="nav-item">
							...
							<span class="nav-link btn-round" href="#">
						...
						<?php if (!Yii::$app->user->isGuest) { ?>
							...
							<?php echo Html::img('@web/uploads/'. Yii::$app->user->identity->profile_picture , ['class' => 'avatar-img rounded-circle']) ?>
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								...
								<li>
										<a class="dropdown-item" href="<?php echo Url::to(['user/dashboard']); ?>">Dashboard</a>
									</li>
									<li>
